                            ...
                            <tbody class="divide-y divide-white/5">
                                ...
                                <tr>
                                    ...
                                    <td class="hidden py-4 pl-0 pr-4 sm:table-cell sm:pr-8">
                                        ...
                                        <div class="font-mono text-sm text-gray-400">{{ Number::currency($product->price, 'EUR', 'en') }}</div>
                                        </div>
                                    </td>

                                    <td class="hidden py-4 pl-0 pr-8 text-sm/6 text-gray-400 md:table-cell lg:pr-20">25s
                                    </td>
